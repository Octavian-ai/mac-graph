...
def get_args(extend=lambda parser:None):
	...
	parser.add_argument('--kb-width',              type=int, default=7,   help="Width of entry into graph table aka the knowledge base")
	...
	parser.add_argument('--max-decode-iterations', type=int, default=6)
